...
# file-specific
name <- "neuropath_corr"
source_synId <- "syn22017882"
old_synId <-  "syn22167182" # m46 v10 Live
new_synId <-  "syn22130742" # v51 Testing
...
***
* !is.na(gname)/field_length(gname, min = 0, max = 100)
8516 fails - missing hngc from source data
