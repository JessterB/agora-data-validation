...
# file-specific
name <- "proteomics_tmt"
source_synId <- "syn35221005" # csv
old_synId <-  "syn33344657" # m46 v4 Live
new_synId <- "syn32210527" # v49 Testing
...
4x hgnc_symbol rules - need to revalidate after adding column_rename
