...
source_synId <- "syn18689335"
old_synId <-  "syn31510062" # TODO update when we have a live data file
...
for (tissue in tissues) {
    ...
    dist_tissue <- proteomics_distribution_data_new[proteomics_distribution_data_new$tissue == tissue,]
