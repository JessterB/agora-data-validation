...
***
* is_unique(ensembl_gene_id): 4 fails -> NEW 0 fails
* !is.na(hgnc_symbol)/field_length(hgnc_symbol, min = 0, max = 100): 15996 - NA values -> NEW 1967
* !is.na(name)/field_length(name, min = 0, max = 200): 15996 - NA values -> NEW 19368
* !is.na(summary): 42408 fails - NA values -> NEW 44167
