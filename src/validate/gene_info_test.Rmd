...
# new_synId <-  "syn26868959" # test_data_full
new_synId <- "syn27407632" # test_data_release_1.0.0
...
## uniques
- 21,293 non-unique hgncs
- 1,282 of these aren't blank strings -> mostly small rnas
...
dup_hgnc_fails <- is_unique_fails[is_unique_fails$hgnc_symbol != "",]
sorted_dups <- dup_hgnc_fails[order(dup_hgnc_fails$hgnc_symbol),]
...
Resolution: Relax the rules for both hgnc and name
