...
gene_source_synId <- "syn25953363" # gene_table_merged.feather
igap_source_synId <- "syn12514826" # igap_genetic_association_genes.csv
eqtl_source_synId <- "syn12514912" # eqtl_meta_analysis.csv
proteomics_source_synId <- "syn18689335" # Final_Agora_DE.csv
proteomics_tmt_source_synId <- "syn35221005" # ROSMAP_DiffExp_TMTproteins.csv
rna_de_source_synId <- "syn27211942" # differentialExpressionSummary.tsv

old_synId <-  "syn12548902" # m46 v37 Live
new_synId <- "syn17015359" # v87 Testing
...
***
* is_unique(ensembl_gene_id): 4 fails
* !is.na(hgnc_symbol)/field_length(hgnc_symbol, min = 0, max = 100): 15996 - NA values
* !is.na(name)/field_length(name, min = 0, max = 200): 15996 - NA values
* !is.na(summary): 42408 fails - NA values
