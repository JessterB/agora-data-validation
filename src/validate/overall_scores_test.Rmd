...
old_synId <-  "syn25741025.5" 
#new_synId <-  "syn25740976"
new_synId <-  "syn33333076"
...
* !is.na(GeneName), 	field_length(GeneName, min = 0, max = 100): 5447 fails -> 5069 with v13 source
* !is.na(LiteratureScore), in_range(LiteratureScore, min = 0, max = 2): 9003 fails -> 16188 with v13 source
* !is.na(OmicsScore), in_range(OmicsScore, min = 0, max = 2): 783 fails -> 910 fails with v13 source
