...
* field_length(ensembl_gene_id, n = 15): 1 fail - See AG-351 (TL;DR - ignore this failure)
* is.na(ensembl_gene_id) and  field_length(ensembl_gene_id, n=15): 1 fail/1 NA respectively (see AG-905)
