...
source_synId <- "syn27211878" # amp_ad_median_expression.csv 
...
```{r echo=FALSE}
source("~/repos/rstudio/agora-data-validation/src/utils.R")
compare_subobjects(get(old_name), get(new_name), "medianexpression")
```
...
* is_unique(ensembl_gene_id, tissue): 18 fails (AG-547)
...
https://sagebionetworks.jira.com/browse/AG-547 - dup records
